...
source /home/administrator/catkin_ws_swarm2/devel/setup.bash
...
export DINGO_LASER_OFFSET="0 0 0" # wrt front_mount in the description
...
export DINGO_LASER_SECONDARY_OFFSET="0 0 0" # wrt rear_mount in the description
