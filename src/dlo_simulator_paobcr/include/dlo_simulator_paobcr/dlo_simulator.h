...
private:
    ...
    pbd_object::MeshDLO createMeshDLO(const std::string &name, const Real &dlo_l, const Real &dlo_z, const Real &dlo_res);
    ...
    */
    ...
    Real dlo_r_;
    Real dlo_density_;
    Real dlo_resolution_; // particle resolution per meter

    Real dlo_stretching_compliance_;
    Real dlo_shearing_compliance_x_;
    Real dlo_shearing_compliance_y_;

    Real dlo_twisting_compliance_;
    Real dlo_bending_compliance_x_;
    Real dlo_bending_compliance_y_;
