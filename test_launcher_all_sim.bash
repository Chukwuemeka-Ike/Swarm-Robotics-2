...
gnome-terminal --tab --title="Sim D1" --command "bash -c \"source ~/.bashrc; roslaunch swarm2_launch sim_dingos.launch; exec bash\"";
sleep 5s;

gnome-terminal --tab --title="Sim Fabric" --command "bash -c \"source ~/.bashrc; roslaunch swarm2_launch sim_fabric.launch; exec bash\"";
sleep 1s;

gnome-terminal --tab --title="UI Tablet" --command "bash -c \"source ~/.bashrc; roslaunch swarm2_launch ui_tablet.launch; exec bash\"";
sleep 1s;
